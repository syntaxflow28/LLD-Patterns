...
**Related:** [Interview Approach](1-approach.md) has the minute-by-minute interview framework and a shorter
version of the entity-classification table. [SOLID Principles](3-solid.md) explains the principles these rules
...
Next: [SOLID Principles](3-solid.md) for the principles these rules come from, or
[the classic problems](../3-reference/2-problems.md) to watch the rules applied to 26 real problems.
